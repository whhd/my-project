    document.addEventListener('DOMContentLoaded',()=>{
            ...
            Carousel.prototype.stop = function(){
             ...
             function showTime(){
                 ...
                 // 拼接时间格式，写入页面
                 countDown.innerHTML ="剩余 :"+ days + '天' + hour + '时' + min + '分' + sec + '秒';
                }

                document.addEventListener('DOMContentLoaded',function(){
                    var dzl = document.querySelector('.dzl');
                    var sp = document.querySelector('.sp');
                    var items = sp.querySelectorAll('span');
                    var dxm = dzl.querySelectorAll('dzm');
                            ...
                            items[i].onclick = (function(i){
                                ...
                                return function(){
                                    for(var j=0;j<items.length;j++){
                                        ...
                                        dxm[j].style.display = 'none';
                                    }
        
                                   
                                   dzm[i].style.display = 'block';
                                }
                            })(i);
                        // })(i);
                    }
